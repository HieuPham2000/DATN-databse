...
--
-- Table pvo_v1_2023.example_link does not contain any data (it is empty)
...
--
-- Table pvo_v1_2023.concept_link does not contain any data (it is empty)

-- 
-- Dumping data for table concept
--
-- Table pvo_v1_2023.concept does not contain any data (it is empty)
...
--
-- Table pvo_v1_2023.tone does not contain any data (it is empty)

-- 
-- Dumping data for table register
--
-- Table pvo_v1_2023.register does not contain any data (it is empty)

-- 
-- Dumping data for table nuance
--
-- Table pvo_v1_2023.nuance does not contain any data (it is empty)

-- 
-- Dumping data for table mode
--
-- Table pvo_v1_2023.mode does not contain any data (it is empty)
...
--
-- Table pvo_v1_2023.dialect does not contain any data (it is empty)

-- 
-- Dumping data for table concept_relationship
--
-- Table pvo_v1_2023.concept_relationship does not contain any data (it is empty)
